...
class KTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.black),
    ...
    bodySmall: TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w500, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineSmall: TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.white),
    ...
    bodySmall: TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w500, color: Colors.white),
